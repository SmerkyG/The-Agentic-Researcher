...
- Read work-branch `condensed_report.md` first for the compact current findings, then
  the highest numbered `report_pageN.md` and relevant older pages, work-branch
  `TODO.md`, report figures, logs, plots, and metric outputs relevant to the
  assigned experiments. `report_page1.md` is the oldest page, higher page
  numbers are newer, and the highest page number is current. Work-branch
