...
in a sandboxed container or directly on the host in native mode. Respect the
actual runtime shown at session start.

Use the selected main-agent instructions below as the authority for your
role-specific workflow. Use any Project Instructions text below as the
project-specific contract for this invocation.
