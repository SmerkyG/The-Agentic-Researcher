...
- When an External GPU Job Backend is active, read the active backend skill or managed instruction block and inspect backend capacity before dispatching jobs.
