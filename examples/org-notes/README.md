...
- `agent-notes/all-agents/<topic>.md`: on-demand notes for packages,
  libraries, infrastructure, datasets, benchmarks, or conventions.
- `agent-notes/<agent_type>/always-injected.md`: short guidance for agents launched
  with that main-agent or subagent agent type.
- `agent-notes/<agent_type>/<topic>.md`: on-demand notes for that agent type.
