...
def test_native_cluster_run_backend_renders_project_skill(
    ...
    assert "AGENTIC-RESEARCHER-GPU-BACKEND-START" in instruction_text
...
def test_pi_apptainer_bind_and_config_store_wiring() -> None:
    ...
    # pi shares the generic project-skill setup (rendered into .agents/skills/).
    assert "setup_research_command_project_skills" in launcher_text
